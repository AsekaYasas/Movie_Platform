...
public class AdminService {
    ...
    public ResponseEntity<?> addMovie(Movie movie, Integer requesterId) {
        ResponseEntity<?> auth = checkAdmin(requesterId);
        if (auth != null) return auth;
        return ResponseEntity.ok(movieRepository.save(movie));
    }

    public ResponseEntity<?> deleteMovie(Integer id, Integer requesterId) {
        ResponseEntity<?> auth = checkAdmin(requesterId);
        if (auth != null) return auth;
    ...
    public ResponseEntity<?> promoteToAdmin(Integer id, Integer requesterId) {
    ...
    public ResponseEntity<?> demoteToUser(Integer id, Integer requesterId) {
        ResponseEntity<?> auth = checkSuperAdmin(requesterId);
        if (auth != null) return auth;
